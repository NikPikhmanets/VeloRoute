package com.nikpikhmanets.veloroute.gpx.xml;

import com.nikpikhmanets.veloroute.gpx.data.GPXBaseEntity;
import com.nikpikhmanets.veloroute.gpx.data.GPXBasePoint;
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        // Track Points / Way Points / Route Points tags
            ...
            if (mCurrentTrackPoint != null) {
                mCurrentTrackPoint.setDescription(mStringBuffer.toString());
            } else if (mCurrentWayPoint != null) {
                mCurrentWayPoint.setDescription(mStringBuffer.toString());
            } else if (mCurrentRoutePoint != null) {
                mCurrentRoutePoint.setDescription(mStringBuffer.toString());
            } else if (mCurrentTrack != null) {
                mCurrentTrack.setUserDescription(mStringBuffer.toString());
            } else if (mCurrentRoute != null) {
                mCurrentRoute.setUserDescription(mStringBuffer.toString());
            }
            ...
            if (stringValue.length() > 0) {
                ...
                if (mCurrentTrackPoint != null) {
                    mCurrentTrackPoint.setElevation(elevation);
                } else if (mCurrentWayPoint != null) {
                    mCurrentWayPoint.setElevation(elevation);
                } else if (mCurrentRoutePoint != null) {
                    mCurrentRoutePoint.setElevation(elevation);
                }
            }
            ...
            if (stringValue.length() > 0) {
                ...
                if (mCurrentTrackPoint != null) {
                    mCurrentTrackPoint.setHDop(hdop);
                } else if (mCurrentWayPoint != null) {
                    mCurrentWayPoint.setHDop(hdop);
                } else if (mCurrentRoutePoint != null) {
                    mCurrentRoutePoint.setHDop(hdop);
                }
            }
            ...
            if (stringValue.length() > 0) {
                ...
                if (mCurrentTrackPoint != null) {
                    mCurrentTrackPoint.setVDop(vdop);
                } else if (mCurrentWayPoint != null) {
                    mCurrentWayPoint.setVDop(vdop);
                } else if (mCurrentRoutePoint != null) {
                    mCurrentRoutePoint.setVDop(vdop);
                }
            }
            ...
            if (mCurrentTrackPoint != null) {
                mCurrentTrackPoint.setName(mStringBuffer.toString());
            } else if (mCurrentWayPoint != null) {
                mCurrentWayPoint.setName(mStringBuffer.toString());
            } else if (mCurrentRoutePoint != null) {
                mCurrentRoutePoint.setName(mStringBuffer.toString());
            } else if (mCurrentTrack != null) {
                mCurrentTrack.setName(mStringBuffer.toString());
            } else if (mCurrentRoute != null) {
                mCurrentRoute.setName(mStringBuffer.toString());
            }
            ...
            if (mCurrentTrackPoint != null) {
                mCurrentTrackPoint.setTimeStamp(date);
            } else if (mCurrentWayPoint != null) {
                mCurrentWayPoint.setTimeStamp(date);
            } else if (mCurrentRoutePoint != null) {
                mCurrentRoutePoint.setTimeStamp(date);
            }

        } else if (localName.equalsIgnoreCase(GPXBasePoint.XML.TAG_TYPE)) {
            if (mCurrentTrackPoint != null) {
                mCurrentTrackPoint.setType(mStringBuffer.toString());
            } else if (mCurrentWayPoint != null) {
                mCurrentWayPoint.setType(mStringBuffer.toString());
            } else if (mCurrentRoutePoint != null) {
                mCurrentRoutePoint.setType(mStringBuffer.toString());
